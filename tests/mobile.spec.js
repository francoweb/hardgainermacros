...
test.describe('Plano 14 Dias no mobile - tema e espacamento visual', () => {
  test('C-MOBILE-THEME-1 - botao de tema visivel no mobile alterna e nao quebra o layout', async ({ page }) => {
    await gotoPlanoMobile(page);
    ...
    expect(scrollW, 'Theme toggle no mobile nao deve criar overflow horizontal').toBeLessThanOrEqual(390);
  });

  test('C-MOBILE-THEME-2 - faixa de macros mantem padding lateral e sem overflow em 390px', async ({ page }) => {
    await gotoPlanoMobile(page);
