...
export const FOODS = {
  ...
  lombo_porco: {
    ...
    category: 'protein',
    per100: { kcal: 182, prot: 27, carb: 0, fat: 8 },
    units: [{ label: 'porção média', grams: 130 }],
    digestibility: 'media',
    substitutes: ['peito_frango', 'alcatra_grelhada', 'peito_peru'],
    source: 'USDA',
  },
  sardinha_lata: {
    name: 'Sardinha em lata (azeite)',
    category: 'protein',
    per100: { kcal: 208, prot: 24, carb: 0, fat: 12 },
    units: [{ label: 'lata pequena', grams: 90 }],
    digestibility: 'leve',
    substitutes: ['atum_agua', 'bacalhau_fresco', 'peixe_salmao'],
    source: 'TACO',
  },
  proteina_ervilha: {
    name: 'Proteína de ervilha (pó)',
    category: 'protein',
    per100: { kcal: 370, prot: 80, carb: 7, fat: 2 },
    units: [{ label: 'scoop (30g)', grams: 30 }],
    digestibility: 'leve',
    substitutes: ['whey', 'caseina', 'tofu'],
    source: 'rotulo',
  },
  queijo_parmesao: {
    name: 'Queijo parmesão ralado',
    category: 'dairy',
    per100: { kcal: 392, prot: 36, carb: 3, fat: 26 },
    units: [{ label: 'colher de sopa', grams: 10 }],
    digestibility: 'media',
    substitutes: ['queijo_mussarela', 'queijo_branco', 'queijo_cottage'],
    source: 'USDA',
  },
  ricotta: {
    name: 'Ricotta',
    category: 'dairy',
    per100: { kcal: 174, prot: 11, carb: 3, fat: 13 },
    units: [{ label: 'porção', grams: 100 }],
    digestibility: 'leve',
    substitutes: ['queijo_cottage', 'iogurte_grego', 'skyr'],
    source: 'USDA',
  },
  proteina_arroz: {
    name: 'Proteína de arroz (pó)',
    category: 'protein',
    per100: { kcal: 360, prot: 78, carb: 8, fat: 3 },
    units: [{ label: 'scoop (30g)', grams: 30 }],
    digestibility: 'leve',
    substitutes: ['proteina_ervilha', 'whey', 'caseina'],
    source: 'rotulo',
  },
  mass_gainer: {
    name: 'Mass gainer hipercalórico (pó)',
    category: 'extra',
    per100: { kcal: 380, prot: 15, carb: 75, fat: 3 },
    units: [{ label: 'dose (100g)', grams: 100 }],
    digestibility: 'leve',
    substitutes: ['whey', 'aveia_flocos', 'leite_po'],
    source: 'rotulo',
  },
  ...
  pao_centeio: {
    name: 'Pão de centeio',
    category: 'carb',
    per100: { kcal: 259, prot: 8, carb: 48, fat: 3 },
    units: [{ label: 'fatia', grams: 35 }],
    digestibility: 'media',
    substitutes: ['pao_frances', 'pao_forma', 'wrap_tortilha'],
    source: 'USDA',
  },
  granola: {
    ...
    category: 'carb',
    per100: { kcal: 471, prot: 10, carb: 64, fat: 20 },
    units: [{ label: 'porção (50g)', grams: 50 }],
    digestibility: 'media',
    substitutes: ['aveia_flocos', 'creme_arroz', 'bagel'],
    source: 'TACO',
  },
  farinha_aveia: {
    name: 'Farinha de aveia',
    category: 'carb',
    per100: { kcal: 394, prot: 13, carb: 66, fat: 7 },
    units: [{ label: 'colher de sopa', grams: 20 }],
    digestibility: 'media',
    substitutes: ['aveia_flocos', 'creme_arroz', 'granola'],
    source: 'TACO',
  },
  massa_integral: {
    name: 'Massa integral cozida',
    category: 'carb',
    per100: { kcal: 124, prot: 5, carb: 23, fat: 1 },
    units: [{ label: 'porção (200g)', grams: 200 }],
    digestibility: 'media',
    substitutes: ['macarrao_cozido', 'arroz_integral_cozido', 'quinoa_cozida'],
    source: 'USDA',
  },
  creme_milho: {
    name: 'Creme de milho',
    category: 'carb',
    per100: { kcal: 72, prot: 2, carb: 16, fat: 1 },
    units: [{ label: 'porção (200ml)', grams: 200 }],
    digestibility: 'leve',
    substitutes: ['polenta', 'cuscuz', 'mandioca_cozida'],
    source: 'TACO',
  },
  barra_cereal: {
    name: 'Barra de cereal',
    category: 'carb',
    per100: { kcal: 420, prot: 7, carb: 70, fat: 12 },
    units: [{ label: 'barra (30g)', grams: 30 }],
    digestibility: 'leve',
    substitutes: ['granola', 'aveia_flocos', 'datil'],
    source: 'rotulo',
  },
  batata_frita: {
    name: 'Batata frita (imersão)',
    category: 'carb',
    per100: { kcal: 312, prot: 3, carb: 41, fat: 15 },
    units: [{ label: 'porção (150g)', grams: 150 }],
    digestibility: 'media',
    substitutes: ['batata_cozida', 'batata_doce_cozida', 'pure_batata'],
    source: 'TACO',
  },
  ...
  chocolate_negro: {
    ...
    category: 'fat',
    per100: { kcal: 598, prot: 8, carb: 46, fat: 43 },
    units: [{ label: 'quadrado (10g)', grams: 10 }],
    digestibility: 'media',
    substitutes: ['cacau_po', 'pasta_amendoim', 'nozes'],
    source: 'USDA',
  },
  creme_leite: {
    name: 'Creme de leite',
    category: 'fat',
    per100: { kcal: 327, prot: 2, carb: 3, fat: 35 },
    units: [{ label: 'colher de sopa (15ml)', grams: 15 }],
    digestibility: 'media',
    substitutes: ['leite_integral', 'oleo_coco', 'abacate'],
    source: 'TACO',
  },
  coco_ralado: {
    name: 'Coco ralado seco',
    category: 'fat',
    per100: { kcal: 660, prot: 7, carb: 24, fat: 62 },
    units: [{ label: 'colher de sopa (10g)', grams: 10 }],
    digestibility: 'fibrosa',
    substitutes: ['oleo_coco', 'pasta_amendoim', 'castanha_para'],
    source: 'USDA',
  },
  oleo_girassol: {
    ...
    category: 'fat',
    per100: { kcal: 884, prot: 0, carb: 0, fat: 100 },
    units: [{ label: 'colher de sopa (15ml)', grams: 14 }],
    digestibility: 'leve',
    substitutes: ['azeite', 'oleo_coco'],
    source: 'USDA',
  },
  azeite_abacate: {
    name: 'Azeite de abacate',
    category: 'fat',
    per100: { kcal: 884, prot: 0, carb: 0, fat: 100 },
    units: [{ label: 'colher de sopa (15ml)', grams: 14 }],
    digestibility: 'leve',
    substitutes: ['azeite', 'oleo_girassol', 'oleo_coco'],
    source: 'rotulo',
  },
  banha_porco: {
    name: 'Banha de porco',
    category: 'fat',
    per100: { kcal: 902, prot: 0, carb: 0, fat: 100 },
    units: [{ label: 'colher de sopa (15g)', grams: 15 }],
    digestibility: 'media',
    substitutes: ['oleo_girassol', 'azeite', 'oleo_coco'],
    source: 'USDA',
  },
  manteiga: {
    name: 'Manteiga',
    category: 'fat',
    per100: { kcal: 717, prot: 1, carb: 0, fat: 81 },
    units: [{ label: 'colher de sopa (15g)', grams: 15 }],
    digestibility: 'media',
    substitutes: ['oleo_girassol', 'azeite', 'banha_porco'],
    source: 'USDA',
  },
  ...
  abacaxi: {
    name: 'Abacaxi',
    category: 'fruit',
    per100: { kcal: 50, prot: 1, carb: 13, fat: 0 },
    units: [{ label: 'fatia média', grams: 80 }],
    digestibility: 'leve',
    substitutes: ['manga', 'mamao', 'maca'],
    source: 'TACO',
  },
  uva_passa: {
    name: 'Uva passa',
    category: 'fruit',
    per100: { kcal: 299, prot: 3, carb: 79, fat: 0 },
    units: [{ label: 'porção (30g)', grams: 30 }],
    digestibility: 'leve',
    substitutes: ['datil', 'banana_prata', 'manga'],
    source: 'USDA',
  },
  kiwi: {
    name: 'Kiwi',
    category: 'fruit',
    per100: { kcal: 61, prot: 1, carb: 15, fat: 1 },
    units: [{ label: 'unidade média', grams: 70 }],
    digestibility: 'leve',
    substitutes: ['maca', 'pera', 'abacaxi'],
    source: 'USDA',
  },
  morango: {
    name: 'Morango',
    category: 'fruit',
    per100: { kcal: 32, prot: 1, carb: 8, fat: 0 },
    units: [{ label: 'unidade', grams: 12 }],
    digestibility: 'leve',
    substitutes: ['kiwi', 'maca', 'abacaxi'],
    source: 'TACO',
  },
};
